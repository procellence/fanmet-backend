...
import { FetchUserByEmailRequest } from '../../models/requests/user-request';

const HttpsError = https.HttpsError;

@Service()
export default class FetchUserDetailByEmailFunction {
  ...
  async main(req: CallableRequest<FetchUserByEmailRequest>): Promise<User[]> {
    ...
    return this.usersDao.fetchUserByUserEmailId(userRequest.email);
  }
